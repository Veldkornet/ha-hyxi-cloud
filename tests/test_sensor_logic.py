...
def test_energy_sensor_anti_dip():
    ...
    val = sensor.native_value
    print(
        f"[2] Cloud Glitch! Reported: 2726.30 | Sensor Output: {sensor.native_value} kWh"
    )
    assert val == 2731.90
    ...
    val = sensor.native_value
    print(
        f"[3] Midnight Reset! Reported: 0.5 | Sensor Output: {sensor.native_value} kWh"
    )
    assert val == 0.5
    ...
    val = sensor.native_value
    print(
        f"[4] Ghost Spike! Reported: 1002731.90 | Sensor Output: {sensor.native_value} kWh"
    )
